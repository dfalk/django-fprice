...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductCategory.lft'
        db.add_column('fprice_productcategory', 'lft', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'ProductCategory.rght'
        db.add_column('fprice_productcategory', 'rght', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'ProductCategory.tree_id'
        db.add_column('fprice_productcategory', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'ProductCategory.level'
        db.add_column('fprice_productcategory', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductCategory.lft'
        db.delete_column('fprice_productcategory', 'lft')

        # Deleting field 'ProductCategory.rght'
        db.delete_column('fprice_productcategory', 'rght')

        # Deleting field 'ProductCategory.tree_id'
        db.delete_column('fprice_productcategory', 'tree_id')

        # Deleting field 'ProductCategory.level'
        db.delete_column('fprice_productcategory', 'level')
