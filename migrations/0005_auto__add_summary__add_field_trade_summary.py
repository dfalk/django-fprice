...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fprice_summary', (
            ...
            ('shop', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fprice.Shop'], null=True, blank=True)),
            ('summary', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=2)),
            ('currency', self.gf('django.db.models.fields.CharField')(default='rur', max_length=3)),
        ))
        db.send_create_signal('fprice', ['Summary'])

        # Adding field 'Trade.summary'
        db.add_column('fprice_trade', 'summary', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fprice.Summary'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Summary'
        db.delete_table('fprice_summary')

        # Deleting field 'Trade.summary'
        db.delete_column('fprice_trade', 'summary_id')
