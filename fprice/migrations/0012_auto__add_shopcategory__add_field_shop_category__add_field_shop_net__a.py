...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fprice_shopcategory', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['fprice.ShopCategory'])),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('fprice', ['ShopCategory'])

        # Adding field 'Shop.category'
        db.add_column('fprice_shop', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fprice.ShopCategory'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Shop.net'
        db.add_column('fprice_shop', 'net',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='net_shops', null=True, to=orm['fprice.Shop']),
                      keep_default=False)

        # Adding field 'Shop.mall'
        db.add_column('fprice_shop', 'mall',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mall_shops', null=True, to=orm['fprice.Shop']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ShopCategory'
        db.delete_table('fprice_shopcategory')

        # Deleting field 'Shop.category'
        db.delete_column('fprice_shop', 'category_id')

        # Deleting field 'Shop.net'
        db.delete_column('fprice_shop', 'net_id')

        # Deleting field 'Shop.mall'
        db.delete_column('fprice_shop', 'mall_id')
    ...
    models = {
        ...
        'fprice.shop': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fprice.ShopCategory']", 'null': 'True', 'blank': 'True'}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fprice.City']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mall': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'mall_shops'", 'null': 'True', 'to': "orm['fprice.Shop']"}),
            'net': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'net_shops'", 'null': 'True', 'to': "orm['fprice.Shop']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'fprice.shopcategory': {
            'Meta': {'ordering': "['title']", 'object_name': 'ShopCategory'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['fprice.ShopCategory']"}),
            'position': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
