...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fprice_shopproduct', (
            ...
            ('last_price', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fprice.Price'], null=True, blank=True)),
        ))
        db.send_create_signal('fprice', ['ShopProduct'])

        # Adding field 'Price.shop_product'
        db.add_column('fprice_price', 'shop_product',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fprice.ShopProduct'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'ShopProduct'
        db.delete_table('fprice_shopproduct')

        # Deleting field 'Price.shop_product'
        db.delete_column('fprice_price', 'shop_product_id')
