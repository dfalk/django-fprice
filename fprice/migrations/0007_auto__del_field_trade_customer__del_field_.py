...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Trade.customer'
        db.delete_column('fprice_trade', 'customer_id')

        # Deleting field 'Trade.time'
        db.delete_column('fprice_trade', 'time')

        # Deleting field 'Trade.time_added'
        db.delete_column('fprice_trade', 'time_added')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Trade.customer'
        raise RuntimeError("Cannot reverse this migration. 'Trade.customer' and its values cannot be restored.")
        # Adding field 'Trade.time'
        db.add_column('fprice_trade', 'time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Trade.time_added'
        db.add_column('fprice_trade', 'time_added',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)
