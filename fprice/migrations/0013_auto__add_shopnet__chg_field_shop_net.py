...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShopNet'
        db.create_table('fprice_shopnet', (
        ...
        db.send_create_signal('fprice', ['ShopNet'])


        # Changing field 'Shop.net'
        db.alter_column('fprice_shop', 'net_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['fprice.ShopNet']))

    def backwards(self, orm):
        # Deleting model 'ShopNet'
        db.delete_table('fprice_shopnet')


        # Changing field 'Shop.net'
        db.alter_column('fprice_shop', 'net_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['fprice.Shop']))
    ...
    models = {
        ...
        'fprice.shop': {
            ...
            'net': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'net_shops'", 'null': 'True', 'to': "orm['fprice.ShopNet']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'fprice.shopcategory': {
        ...
        'fprice.shopnet': {
            'Meta': {'ordering': "['title']", 'object_name': 'ShopNet'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'position': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
